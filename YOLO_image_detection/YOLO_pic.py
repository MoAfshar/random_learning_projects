...
## Load YOLO
network = cv2.dnn.readNet('C:\\Users\\945970\\Desktop\\YOLO\\yolov3.weights', 'C:\\Users\\945970\\Desktop\\YOLO\\yolov3.cfg')
classes = []
...
## Load image
img = cv2.imread('C:\\Users\\945970\\Desktop\\YOLO\\hk.jpg')
img = cv2.resize(img, None, fx=0.7, fy=0.7)
height, width, channels = img.shape

## Detecting objects, to be able to extreact features from this image
blob = cv2.dnn.blobFromImage(image=img, size=(416,416), scalefactor=(0.00392), mean=(0,0,0), swapRB=True, crop=False)
...
for object in range(num_objects_detected):
    if object in indexes:
        ...
        cv2.putText(img, label, (x, y + 50), font, 1, colour, 2)
